...
#endif
    //
#if (RTC_CLK_EN && (PRODUCT_VERSION_KEYI == 0))
    &rtc_task_info, ///<RTC
#endif
#if (RTC_CLK_EN && PRODUCT_VERSION_KEYI)
	&keyi_rtc_task_info,//4
#endif
    //
#if REC_MODE_EN
    &rec_task_info, ///<REC
