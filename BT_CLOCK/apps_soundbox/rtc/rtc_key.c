...
#if (PRODUCT_VERSION_KEYI == 1)
#define ADKEY_SETTING_RTC_SHORT	\
						/*00*/	  NO_MSG,\
						/*01*/	  NO_MSG,\
						/*02*/	  NO_MSG,\
						/*03*/	  NO_MSG,\
...
#define ADKEY_SETTING_RTC_LONG	\
							...
							/*08*/	  NO_MSG,\
							/*09*/	  NO_MSG,
#define ADKEY_SETTING_RTC_LONG_UP	\
							/*00*/	  NO_MSG,\
							/*01*/	  NO_MSG,\
							/*02*/	  NO_MSG,\
							/*03*/	  MSG_RTC_PLUS,\
...
const u8 rtc_setting_ad_table[4][10] =
{
    /*短按*/	    {ADKEY_SETTING_RTC_SHORT},
					/* Set all to no message */
    /*长按*/		{ADKEY_SETTING_RTC_LONG},
    /*连按*/		{ADKEY_RTC_LONG_UP},
    /*长按抬起*/	{ADKEY_SETTING_RTC_LONG_UP},
};
#endif
