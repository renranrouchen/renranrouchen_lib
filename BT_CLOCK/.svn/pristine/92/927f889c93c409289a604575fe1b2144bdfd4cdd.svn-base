...
/*----------------------------------------------------------------------------*/
/**@brief  PC 模式静音状态�?�置
   @param  mute_status：mute状态控制；fade_en：淡入淡出�?�置
   @return �?
...
s32 app_usb_slave_init(void)
{
	...
	{
		dac_set_samplerate(48000, 0);     //DAC采样率�?�置�?48K
		pc_dac_channel_on(); //开PC DAC模拟通道
	}

    /*MASS STORAGE、AUDIO和HID功能重新设置:默�?�全开*/
	usb_slave_class_config_reset(dev_io);

	/*register card_reader 属�?*/
