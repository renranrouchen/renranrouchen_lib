...
extern const unsigned char  dis[10] ;
...
{1,0x00000001},{2,0x00000010},{3,0x00000100},{4,0x00001000},{5,0x00010000},{6,0x00100000},{7,0x01000000},{8,0x10000000},
{9,0x00000002},{10,0x00000020},{11,0x00000200},{12,0x00002000},{13,0x00020000},{14,0x00200000},{15,0x02000000},{16,0x20000000},
{17,0x00000004},{18,0x00000040},{19,0x00000400},{20,0x00004000},{21,0x00040000},{22,0x00400000},{23,0x04000000},{24,0x40000000},
{25,0x00000008},{26,0x00000080},{27,0x00000800},{28,0x00008000},{29,0x00080000},{30,0x00800000},{31,0x08000000},{32,0x80000000},
};
...
//	for(i=0;i<10;i++)
//	{
//			FD612_PotiveTNage(FD612_DIG1_ADDR,dis[i]);
//			FD612_PotiveTNage(FD612_DIG2_ADDR,dis[i] );
//			FD612_PotiveTNage(FD612_DIG3_ADDR,dis[i]);
//			FD612_PotiveTNage(FD612_DIG4_ADDR,dis[i]);
//			FD612_PotiveTNage(FD612_DIG5_ADDR,dis[i] );
//			FD612_PotiveTNage(FD612_DIG6_ADDR,dis[i]);
//			FD612_PotiveTNage(FD612_DIG7_ADDR,dis[i]);
//			FD612_Refresh();
//			mDelaymS(200);		
//	}
//		TR0=1;
...
//		TR0=0;
//		buzzer=0;
//			FD612_DispBuff.DispData[FD612_DIG1_ADDR]=0xff ; 
//			FD612_DispBuff.DispData[FD612_DIG2_ADDR]=0xff;
//			FD612_DispBuff.DispData[FD612_DIG3_ADDR]=0xff ; 
//			FD612_DispBuff.DispData[FD612_DIG4_ADDR]=0xff;
//			FD612_Refresh();
//			mDelaymS(500);
}
